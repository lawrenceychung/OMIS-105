...
CONSTRAINT Appointment_FK3 FOREIGN KEY (CageID)  REFERENCES Boarding_T(CageID));
...
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (01, 1, '01:53', 001, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (02, 2, '01:37', 002, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (03, 3,  '00:53', 003, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (04, 4,  '01:46', 004, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (05, 5,  '01:44', 005, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (06, 6,  '00:33', 006, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (07, 7,  '01:46', 007, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (08, 8,  '00:57', 008, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (09, 9,  '00:23', 009, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (10, 10,  '00:41', 010, '2020-11-10')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (11, 1,  '01:22', 011, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (12, 2, '01:38', 012, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (13, 3, '00:23', 013, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (14, 4, '01:42', 014, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (15, 5, '00:35', 015, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (16, 6, '01:44', 016, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (17, 7, '01:13', 017, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (18, 8, '00:25', 018, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (19, 9, '01:08', 019, '2020-11-11')
INSERT INTO Boarding_T (CageID, CageNumber, TimeInCage, PetID, BoardingDate)
VALUES (20, 10, '01:53', 020, '2020-11-11')

-- Inserting Data for Appointment Table
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
...
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0011, '2020-11-11', '09:00', 011, 11, 11)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0012, '2020-11-11', '09:30', 012, 12, 12)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0013, '2020-11-11', '11:00', 013, 13, 13)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0014, '2020-11-11', '11:00', 014, 14, 14)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0015, '2020-11-11', '11:30', 015, 15, 15)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0016, '2020-11-11', '12:00', 016, 16, 16)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0017, '2020-11-11', '01:00', 017, 17, 17)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0018, '2020-11-11', '01:30', 018, 18, 18)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0019, '2020-11-11', '02:00', 019, 19, 19)
INSERT INTO Appointment_T (AppointmentID, AppointmentDate, DropOffTime, PetID, CustomerID, CageID)
VALUES (0020, '2020-11-11', '02:00', 020, 20, 20)
...
-- Find all the breeds who have showed up more than 1 time and list the appointmentID, Customer ID, and appointment date.
SELECT Appointment_T.AppointmentID, Appointment_T.CustomerID, AppointmentDate, COUNT(Breed) AS NumOfBreeds
FROM Appointment_T INNER JOIN Pet_T ON Appointment_T.CustomerID = Pet_T.CustomerID
GROUP BY Appointment_T.CustomerID
HAVING COUNT(Breed) > 1

--employee & services
SELECT 
FROM Employee_T INNER JOIN Service_T ON Employee_T.EmployeeID = 
WHERE 
ORDER BY 

--Who are the customer who spend the most at Wash Co?
SELECT Customer_T.CustomerID, CustomerName, PaymentAmount
FROM Customer_T INNER JOIN Billing_T ON Customer_T.CustomerID = Billing_T.CustomerID
WHERE PaymentAmount >= 60
