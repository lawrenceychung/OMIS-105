...
INSERT INTO Customer_T  (CustomerID, CustomerName, CustomerAddress, CustomerCity, CustomerState, CustomerPostalCode)
VALUES  (20, 'Will', '4132 Main Street', 'Ogden', 'UT', '84403-4432');
/* insert after addition of ALTER TABLE CUSTOMER_T ADD CustomerType VARCHAR(10) DEFAULT 'Commercial'; = default "commercial customer"*/

INSERT INTO Customer_T  (CustomerID, CustomerName, CustomerAddress, CustomerCity, CustomerState, CustomerPostalCode, CustomerType)
VALUES  (21, 'Bob', '4132 Main Street', 'Ogden', 'UT', '84403-4432', 'Regular');
/* insert after addition of ALTER TABLE CUSTOMER_T ADD CustomerType VARCHAR(10) DEFAULT 'Commercial'; setting customer type to "regular"*/
...
ALTER TABLE CUSTOMER_T ADD CustomerType VARCHAR(10) DEFAULT 'Commercial';

DELETE FROM Customer_T WHERE CustomerState = 'HI';

UPDATE Customer_T SET CustomerState = 'CA' WHERE CustomerID = 21;
